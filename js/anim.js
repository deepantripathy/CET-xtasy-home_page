...
var s2 = new Sprite(shape[2], 490, 200, 1, 1, 0);

var s3 = new Sprite(shape[0], 400, 250, 4, 4, 0);
var s4 = new Sprite(shape[1], 389, 150, 3, 3, 10);
var s5 = new Sprite(shape[2], 589, 100, 2, 2, 0);
// shapeObject.push(s0);
// shapeObject.push(s1);
